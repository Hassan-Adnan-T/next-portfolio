...
export default function Hero() {
  return (
    <section id="home" className="min-h-screen flex items-center pt-20 px-4 sm:px-6 md:px-8 lg:px-16">
      <div className="container mx-auto bg-[#001738] p-8 sm:p-12 md:p-20 lg:p-36 rounded-2xl">
