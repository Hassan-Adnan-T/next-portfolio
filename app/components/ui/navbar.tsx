    ...
    return (
      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <ul className="flex gap-6">
          ...
          <li><a href="#about" className="text-[#020202] font-karla hover:bg-[#F1F1F1] px-3 py-2 rounded-md">About Me</a></li>
          <li><a href="#projects" className="text-[#020202] font-karla hover:bg-[#F1F1F1] px-3 py-2 rounded-md">Projects</a></li>
          <li><a href="#skills" className="text-[#020202] font-karla hover:bg-[#F1F1F1] px-3 py-2 rounded-md">Practicum</a></li>
